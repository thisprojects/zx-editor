// ZX Spectrum ROM character set — ASCII 32–127 (96 characters)
// 8 bytes per character, MSB = leftmost pixel of each row
// Adapted from the Spectrum 48K ROM at address 0x3D00
// prettier-ignore
export const ZX_ROM_FONT = new Uint8Array([
  // 32 SPACE
  ...
  // 48 0  (diagonal slash distinguishes from O)
  ...
  // 64 @
  0x00, 0x3C, 0x42, 0x5C, 0x54, 0x5C, 0x40, 0x3C,
  // 65 A
  ...
  // 83 S
  0x00, 0x3C, 0x40, 0x3C, 0x02, 0x02, 0x3C, 0x00,
  // 84 T
  ...
  // 102 f
  0x00, 0x1C, 0x20, 0x78, 0x20, 0x20, 0x20, 0x00,
  // 103 g  (descender)
  ...
  // 106 j  (descender)
  0x00, 0x06, 0x00, 0x06, 0x06, 0x06, 0x46, 0x3C,
  // 107 k
  0x00, 0x40, 0x44, 0x48, 0x70, 0x48, 0x44, 0x00,
  // 108 l
  0x00, 0x18, 0x08, 0x08, 0x08, 0x08, 0x1C, 0x00,
  // 109 m
  0x00, 0x00, 0x6C, 0x4A, 0x4A, 0x4A, 0x4A, 0x00,
  // 110 n
  ...
  // 121 y  (descender)
  0x00, 0x00, 0x42, 0x42, 0x3E, 0x02, 0x02, 0x3C,
  // 122 z
  ...
  // 125 }
  0x00, 0x38, 0x08, 0x06, 0x08, 0x38, 0x00, 0x00,
  // 126 © (copyright symbol — ZX Spectrum ROM position)
  0x00, 0x3C, 0x42, 0x4E, 0x42, 0x42, 0x3C, 0x00,
  // 127 DEL (checkerboard inverse-video block)
